...
import skeletors_big_adventure.core.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("skeletors_big_adventure.core.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("skeletors_big_adventure.core.AndroidLauncher");
